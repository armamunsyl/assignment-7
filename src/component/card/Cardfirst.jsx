...
function Cardfirst({selectedTask, resolvedTask}) {
    return (
       <div className='grid grid-cols-1 md:grid-cols-2 gap-6 max-w-7xl mx-auto text-center mt-10'>
    
    <div className='relative h-40 rounded-xl shadow-lg bg-gradient-to-r from-violet-500 to-purple-600 flex flex-col justify-center items-center text-white overflow-hidden'>
    ...
    <div className='relative h-40 rounded-xl shadow-lg bg-gradient-to-r from-green-400 to-emerald-600 flex flex-col justify-center items-center text-white overflow-hidden'>
        <img src={ImgVec1} className="absolute left-0 top-0 h-full object-contain opacity-100" />
        <img src={ImgVec2} className="absolute right-0 top-0 h-full object-contain opacity-100" />
